...
int main() {
    ...
    c1.assign(d1, d2);
    c2.assign(i1, i2);
    std::cout << "compare " << i1 << " and " << i2 << ". greater is " << greater(i1, i2) << "\n";
    std::cout << "compare " << d2 << " and " << i1 << ". greater is " << greater(d2, double(i2)) << "\n";
    std::cout << "compare " << d2 << " and "; c2.print(); std::cout << ". greater is " << greater(d2, double(c2)) << "\n";
    cmax = greater(c1, c2);
    std::cout << "compare "; c1.print(); std::cout << " and "; c2.print(); std::cout << ". greater is "; cmax.print(); std::cout << "\n";
